      ...
      <div className="backgroundPensionados flex min-h-[209px] w-full items-center md:min-h-[204px]">
        <div className="containerMaxWidth mb-6 flex w-full flex-col items-end space-y-4 px-[16px] sm:mb-8 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 md:px-0">
          ...
          <button
            ...
            className="font-poppins bg-primary-positiva hover:bg-navy-primary flex w-full cursor-pointer items-center justify-center space-x-2 rounded-md px-7.5 py-2 text-base font-semibold text-white transition-colors disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto sm:px-6"
